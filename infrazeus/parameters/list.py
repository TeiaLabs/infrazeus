...
def list_secrets(service: Service, show_values: bool = False) -> Optional[dict[str, Any]]:
    ...
    secret_name = service.canonical_name  # Assuming normalized_name is the correct attribute
    ...
    try:
        ...
        for page in page_iterator:
            for param in page['Parameters']:
                ...
                parameter_value_response = client.get_parameter(Name=param['Name'], WithDecryption=True)
